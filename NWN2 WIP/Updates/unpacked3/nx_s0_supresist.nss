...
// End of Spell Cast Hook
	...
	if (GetHasSpellEffect(SPELL_CONVICTION, oTarget))
	{
		RemoveEffectsFromSpell(oTarget, SPELL_CONVICTION);
		SendMessageToPC(oTarget, "Conviction removed by Superior Resistance.");
	}	
	
	if (GetHasSpellEffect(SPELLABILITY_FACTOTUM_ARCDIL, oTarget))
	{
		return;
	}			
