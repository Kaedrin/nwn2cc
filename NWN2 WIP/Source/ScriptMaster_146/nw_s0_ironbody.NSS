...
// RPGplayer1 - 01/10/2009 - Made user immune to Mass Drown spell, removed obsolete Pulse_Drown
...
void main()
{
	...
	effect eElectricI = EffectDamageResistance(DAMAGE_TYPE_ELECTRICAL, 9999, 0);	
	...
	effect eDrown		= EffectSpellImmunity( 1019 );//Immunity to the mass drown spell
	...
	effect eSA = EffectImmunity(IMMUNITY_TYPE_SNEAK_ATTACK); 
    eLink = EffectLinkEffects(eLink, eSA);
