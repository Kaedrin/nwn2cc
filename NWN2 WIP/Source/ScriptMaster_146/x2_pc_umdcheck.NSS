...
int X2_UMD()
{
	...
	{
		if (GetHasSpellEffect(SPELL_STONE_BODY, OBJECT_SELF) || GetHasSpellEffect(SPELL_IRON_BODY, OBJECT_SELF) )
		{
			SendMessageToPC(GetFirstPC(), "Potion use fails while Stone Body or Iron Body are active.");
			return FALSE;
		}
	}
	*/
