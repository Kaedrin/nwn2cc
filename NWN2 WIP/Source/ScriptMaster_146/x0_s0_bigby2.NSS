...
void RunHandImpact(object oTarget, object oCaster)
{
    ...
    if (GZGetDelayedSpellEffectsExpired(nSpellID,oTarget,oCaster))
    {
        ...
        ApplyEffectToObject(DURATION_TYPE_INSTANT, eImpact, oTarget);	
			...
			int nAbilityModifier = nStr;
			if (nDex > nStr)
				nAbilityModifier = nDex;
				
            int nTargetRoll = d20(1) + nAbilityModifier + GetSizeModifier(oTarget);
            ...
            if (nCasterRoll >= nTargetRoll)
            {
               ...
               // effect eKnockdown = EffectDazed();
                ...
                //Link effects
                effect eLink = EffectLinkEffects(eKnockdown2, eVis);
