...
const string HEX_NO_VALID_CURSES = "No more curse uses remain.";

const int POISON_WEAPON_DURATION = 5; // number of rounds the duration is. 3 is the value OEI had.
const int POISON_WEAPON_BLUNT = 1; // 1 for yes, 0 for no
...
const int NATURAL_LEADER_FIX = -4009;
const int NATURAL_LEADER_AURA = -4010;
const int EXPERT_TACTICIAN_FIX = -4011;
const int BLIND_FIGHT_FIX = -4012;
...
const int CLASS_UNDERDARK_MARAUDER = 141;
...
const int CLASS_TEMPLAR = 154;
const int CLASS_MARKSMAN = 155;

const int CLASS_BEASTHEARTADEPT = 165;
const int CLASS_DREAD_COMMANDO = 166;

const int CLASS_MYSTIC_RESV = 169;
const int CLASS_STALKER_DEPTHS = 170;
const int CLASS_KNIGHT_WILD = 171;

const int CLASS_FORCE_MAGE = 173;
...
const int CLASS_HEXBLADE = 185;

const int CLASS_SKALD = 188;

const int CLASS_FACTOTUM = 191;
const int CLASS_VENGTAKE = 192;
...
const int FEAT_UNSTOPPABLE_FEROCITY = 3527;
const int FEAT_GRIM_SURVIVAL = 3528;
...
const int FEAT_NINJA_GHOST_SIGHT = 3651;
...
const int FEAT_EPIC_FIENDISH_RESILIENCE_II = 3745;
const int FEAT_EPIC_FIENDISH_RESILIENCE_III = 3746;
const int FEAT_EPIC_FIENDISH_RESILIENCE_IV = 3747;
...
const int FEAT_HEXCURSE_1 = 3773;

const int FEAT_HEXBOOK_L4_1 = 3816;

const int FEAT_HEX_GRHEXCUR = 3824;
const int FEAT_HEX_AURUNLCK_1 = 3825;

const int FEAT_HEX_DRHEXCUR = 3833;

const int FEAT_CRAFT_ROD  = 3843;
const int FEAT_CRAFT_STAFF = 3844;
const int FEAT_FORGE_RING = 3845;
const int FEAT_TIRELESS = 3846;
const int FEAT_EXTEND_RAGE_II = 3847;
const int FEAT_EXTEND_RAGE_III = 3848;
const int FEAT_EXTEND_RAGE_IV = 3849;
const int FEAT_EPIC_LORD_OF_ALL_ESSENCES = 3850;

const int FEAT_HEXBLADE_ABILITY_FOCUS = 3851;
const int FEAT_HEXBLADE_EXTRA_CURSE_I = 3852;
const int FEAT_HEXBLADE_EXTRA_CURSE_II = 3853;
const int FEAT_HEXBLADE_EXTRA_CURSE_III = 3854;
const int FEAT_HEXBLADE_EXTRA_AURA = 3855;
const int FEAT_HEXBLADE_PRACTICED_CASTER = 3856;
const int FEAT_HEXBLADE_BOON_UNLUCKY = 3857;
const int FEAT_HEXBLADE_EPIC_DARK_COMPANION = 3858;
const int FEAT_HEXBLADE_ARCANE_STRIKE = 3859;
const int FEAT_HEXBLADE_EPIC_CURSE = 3860;
const int FEAT_HEXBLADE_EPIC_MISFORTUNE = 3861;
const int FEAT_HEXBLADE_EPIC_IMPROVED_AURA = 3862;
const int FEAT_HEXBLADE_RHYME_MISFORTUNE = 3863;
const int FEAT_HEXBLADE_LINGERING_CURSE = 3864;
const int FEAT_HEXBLADE_ARCANE_MASTERY = 3865;
const int FEAT_HEXBLADE_MINOR_SHAPESHIFT = 3866;
const int FEAT_HEXBLADE_CURSE_LETHARGY = 3867;
const int FEAT_HEXBLADE_CURSE_SILENCE = 3868;
const int FEAT_DREADFUL_WRATH = 3869;
const int FEAT_DEMORALIZE_OPPONENT = 3870;
const int FEAT_HEXBLADE_EXTRA_SLOT_L1_I = 3871;
const int FEAT_HEXBLADE_EXTRA_SLOT_L1_II = 3872;
const int FEAT_HEXBLADE_EXTRA_SLOT_L2_I = 3873;
const int FEAT_HEXBLADE_EXTRA_SLOT_L2_II = 3874;
const int FEAT_HEXBLADE_EXTRA_SLOT_L3_I = 3875;
const int FEAT_HEXBLADE_EXTRA_SLOT_L3_II = 3876;
const int FEAT_HEXBLADE_EXTRA_SLOT_L4_I = 3877;
const int FEAT_HEXBLADE_EXTRA_SLOT_L4_II = 3878;
const int FEAT_HEXBLADE_XTRASPELL_GHOSTVIS = 3879;
const int FEAT_HEXBLADE_XTRASPELL_SHIELD = 3880;
const int FEAT_HEXBLADE_XTRASPELL_HEROISM = 3881;
const int FEAT_HEXBLADE_XTRASPELL_HASTE = 3882;
const int FEAT_HEXBLADE_XTRASPELL_KEEN = 3883;
const int FEAT_HEXBLADE_XTRASPELL_SPIDERSKIN = 3884;
const int FEAT_HEXBLADE_XTRASPELL_BLOODLETTING = 3885;
const int FEAT_EPIC_HEAVY_ARMOR_OPTIMIZATION = 3886;
const int FEAT_COMBATSTYLE_RANGER_TWO_HANDED = 3887;
const int FEAT_TEMPLAR_SPELLCASTING_PALADIN = 3888;

const int FEAT_MARKSMAN_SPELLCASTING_RANGER = 3890;

const int FEAT_RESERVE_RUNE_FLAME = 3900;
const int FEAT_RESERVE_RUNE_ICE = 3901;
const int FEAT_RESERVE_RUNE_STORMS = 3902;
const int FEAT_RESERVE_RUNE_THUNDER = 3903;
const int FEAT_RESERVE_RUNE_VITRIOL = 3904;

const int FEAT_EPITHET_HIPS_DONTLIE = 3931;

const int FEAT_BLADE_OF_SHADOW = 3939;
const int FEAT_WILDFIRE_BLADES = 3940;
const int FEAT_SHADOW_LYRIST = 3941;
const int FEAT_WARBAND_ARCANIST = 3942;

const int FEAT_HOLY_ICON_WAR = 3945;
const int FEAT_REWARD_OF_LIFE = 3946;
const int FEAT_COMPANION_BARDING = 3947;
const int FEAT_WILD_MARKSMAN = 3948;
const int FEAT_BATTLEFIELD_SURVEYOR = 3949;
const int FEAT_EPIC_EMPTY_BODY = 3950;

const int FEAT_KNIWILD_SPELLCASTING_PALADIN = 3961;
const int FEAT_KNIWILD_SPELLCASTING_RANGER = 3962;

const int FEAT_BEASTHA_SPELLCASTING_RANGER = 3975;

const int FEAT_FACTOTUM_CUN_DEF = 3980;

const int FEAT_MYSTRESV_SPELLCASTING_PALADIN = 3985;
const int FEAT_MYSTRESV_SPELLCASTING_RANGER = 3986;

const int FEAT_HEXBLADE_SIPHONWEAVE = 4006;
const int FEAT_FIGHTER_PASSIVE = 4007;
const int FEAT_FIGHTER_ARMOR_TRAIN = 4008;

const int WholenessofBody2 = 4009;
const int WholenessofBody3 = 4010;
const int WholenessofBody4 = 4011;
const int WholenessofBody5 = 4012;
const int WholenessofBody6 = 4013;
const int WholenessofBody7 = 4014;
const int WholenessofBody8 = 4015;
const int WholenessofBody9 = 4016;
const int WholenessofBody10 = 4017;
const int FEAT_RESERVE_FEAT_MASTERY = 4018;
const int FEAT_EPIC_RESERVE_FEAT_MASTERY = 4019;
const int FEAT_RESERVE_FEAT_ENHANCEMENT = 4020;
const int FEAT_IMPROVED_RESERVE_FEATS = 4021;
const int FEAT_MONK_HEROICKI = 4022;
const int FEAT_EPIC_DIAMOND_SOUL = 4023;
const int FEAT_MONK_FIST_HEAVENS = 4024;
const int FEAT_MONK_LIGHTNING_STRIKES = 4025;
const int FEAT_CHANNEL_POSITIVE_ENERGY = 4026;
const int FEAT_SKALD_HEROS_CALL = 4027;
const int FEAT_SKALD_IMPROVED_HEROS_CALL = 4028;
const int FEAT_SKALD_IMPROVED_INSPIRE_HEROICS = 4029;
const int FEAT_SKALD_GREATER_INSPIRE_HEROICS = 4030;
const int FEAT_SKALD_INSPIRE_HEROICS_TOUGHNESS = 4031;
const int FEAT_VENGTAKE_CURSE_SHADOWS = 4032;
const int FEAT_VENGTAKE_CURSE_BLOOD = 4033;
const int FEAT_VENGTAKE_CURSE_SHATTERING = 4034;
const int FEAT_VENGTAKE_EMPOWERED_CURSES = 4035;
const int FEAT_VENGTAKE_CURSE_LIFEDRAINING = 4036;
const int FEAT_VENGTAKE_HARM_TOUCH = 4037;
const int FEAT_VENGTAKE_VAMP_BLADES = 4038;
const int FEAT_VENGTAKE_EMPOWER_HARM_TOUCH = 4039;
const int FEAT_BG_ARCANE_SERVANT_DARKNESS = 4040;
...
const int SPELL_BG_MANIFEST_DEATH = 1732;
...
const int SPELL_TOWERING_OAK = 2104;
...
const int Greater_Wild_Shape_Bronze_Dragon = 2147;
const int Greater_Wild_Shape_White_Dragon = 2148;

const int Hex_Shield = 2151;
const int Hex_Protection_from_Evil = 2152;
const int Hex_Ghostly_Visage = 2153;
const int Hex_Entropic_Shield =2154;

const int Hex_Haste = 2162;
const int Hex_Spiderskin = 2163;

const int Hex_Protection_from_Energy =2166;

const int Hex_Shadow_Form =2172;
const int SPELLABILITY_HEX_CURSE = 2173;
const int SPELLABILITY_HEX_ARCRES = 2174;
const int SPELLABILITY_HEX_AURA_UNLUCK = 2175;

const int SPELLABILITY_HEX_ARCANE_STRIKE = 2177;

const int SPELLABILITY_HEX_CURSE_LETH = 2179;
const int SPELLABILITY_HEX_CURSE_SIL = 2180;
const int SPELLABILITY_DEMORALIZE_OPPONENT = 2181;

const int SPELLABILITY_DARK_COMPANION = 2183;

const int SPELLABILITY_TEMPLAR_FERVOR = 2200;

const int SPELLABILITY_RUNE_FLAME = 2202;
const int SPELLABILITY_RUNE_ICE = 2203;
const int SPELLABILITY_RUNE_STORMS = 2204;
const int SPELLABILITY_RUNE_THUNDER = 2205;
const int SPELLABILITY_RUNE_VITRIOL = 2206;

const int SPELLABILITY_FACTOTUM_ARCDIL = 2215;
const int SPELLABILITY_FACTOTUM_OPPIETY_HEAL = 2216;
const int SPELLABILITY_FACTOTUM_OPPIETY_HARM = 2217;
const int SPELLABILITY_BLOODEXEMP_FORCEPERS = 2218;
const int SPELLABILITY_HEXBLADE_ARCHEROISM = 2219;
const int SPELLABILITY_FORCEMAGE_FORCEMISS = 2220;
const int SPELLABILITY_HEXBLADE_SIPHONWEAVE = 2221;
const int SPELLABILITY_FIGHTER_PASSIVE = 2222;
const int SPELLABILITY_NINJA_GHOST_SIGHT = 2223;
const int SPELLABILITY_MONK_HEROICKI = 2224;

const int SPELLABILITY_VENGTAKE_CURSE_SHADOWS = 2226;
const int SPELLABILITY_VENGTAKE_CURSE_BLOOD = 2227;

const int SPELLABILITY_VENGTAKE_VAMP_BLADES = 2229;
...
const int SPELLABILITY_COMBATSTYLE_RANGER_TWO_HANDED = -3887;
...
const int VFX_MOB_BODY_SUN_WILDSHAPE = 94;
const int VFX_MOB_NATURAL_LEADER = 95;
const int VFX_PER_DARK_COMP = 96;
const int AOE_RUNE_FLAME = 97;
const int AOE_RUNE_ICE = 98;
const int AOE_RUNE_STORMS = 99;
const int AOE_RUNE_THUNDER = 100;
const int AOE_RUNE_VITRIOL = 101;
...
const int CMI_OPTIONS_RangerFullCaster = 40;
const int CMI_OPTIONS_AllowWildshapeHeal = 41;	
const int CMI_OPTIONS_TreatHellfireBlastSeparate = 42;
const int CMI_OPTIONS_AllowEldBlastToStackMaxEmpower = 43;
const int CMI_OPTIONS_CapIntuitiveIfNotPureMonk = 44;
const int CMI_OPTIONS_UnequipLosesTempProperties = 45;
const int CMI_OPTIONS_UncannyDodgeImprovement = 46;
const int CMI_OPTIONS_UseConFix = 47;
const int CMI_OPTIONS_UseDeathwardFix = 48;


const int METAMAGIC_INVOC_UNDBANE_BLAST = 1;
const int METAMAGIC_INVOC_REPELL_BLAST = 2;
const int METAMAGIC_INVOC_TEMPEST_BLAST = 3;

const int VFX_BEAM_RESONBOLT = 1200;
const int VFXSC_DUR_FAERYAURA_PURPLE = 1201;
const int VFXSC_DUR_FAERYAURA_RED = 1202;
const int VFXSC_DUR_FAERYAURA_GREEN = 1203;
const int VFXSC_DUR_DARK_COMPANION = 1204;
const int VFX_RUNE_FLAME = 1205;
const int VFX_RUNE_ICE = 1206;
const int VFX_RUNE_STORMS = 1207;
const int VFX_RUNE_THUNDER = 1208;
const int VFX_RUNE_VITRIOL = 1209;
...
const int DRAGONSHAPE_BRNZE_DRAGON_24 = 181;
const int DRAGONSHAPE_BRNZE_DRAGON_27 = 182;
const int DRAGONSHAPE_BRNZE_DRAGON_30 = 183;
const int DRAGONSHAPE_WHITE_DRAGON_25 = 184;
const int DRAGONSHAPE_WHITE_DRAGON_28 = 185;
const int DRAGONSHAPE_WHITE_DRAGON_30 = 186;
const int POLYMORPH_TYPE_WAR_TROLL = 187;

const int POLYMORPH_TYPE_LESS_EMBER_GUARD = 207;

const int RACE_DEEP_IMASKARI = 70;
...
void ApplySilverFangEffect(object oTarget)
{
	...
	DelayCommand(1.0f, ApplyEffectToObject(DURATION_TYPE_PERMANENT, eRegen, oTarget));
}
