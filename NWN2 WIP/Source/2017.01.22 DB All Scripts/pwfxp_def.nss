...
const float PWFXP_GLOBAL_MODIFIER = 4.5;
...
const string PWFXP_LEVEL_MODIFIERS = "11.000|06.000|04.000|03.000|02.000|01.700|01.450|01.200|01.000|00.930|00.850|00.800|00.750|00.700|00.630|00.560|00.500|00.430|00.390|00.330|00.270|00.230|00.001|00.001|00.001|00.001|00.001|00.001|00.001|00.001|00.001|00.001|00.001|00.001|00.001|00.001|00.001|00.001|00.001|00.001";
...
const float PWFXP_CR_LESSTHAN_PCLEVEL_REDUCTION = 4.0;
...
const float PWFXP_CR_GREATERTHAN_PCLEVEL_REDUCTION = 5.0;
const float PWFXP_CR_GREATERTHAN_PCLEVEL_NOXP = 9.0;
...
const float PWFXP_GROUPBONUS_MODIFIER = 1.0;
//const float PWFXP_GROUPBONUS_MODIFIER = 0.60; Changed 5/23/2015
...
const float PWFXP_XP_DIVISOR_HENCHMAN = 0.25;
const float PWFXP_XP_DIVISOR_SUMMONED = 0.15;
const float PWFXP_XP_DIVISOR_ANIMALCOMPANION = 0.1;
const float PWFXP_XP_DIVISOR_FAMILIAR = 0.1;

//const float PWFXP_XP_DIVISOR_DOMINATED = 0.5; Changed 5/23/2015
//const float PWFXP_XP_DIVISOR_HENCHMAN = 0.5; Changed 5/23/2015
//const float PWFXP_XP_DIVISOR_SUMMONED = 0.3; Changed 5/23/2015
//const float PWFXP_XP_DIVISOR_ANIMALCOMPANION = 0.2; Changed 5/23/2015
//const float PWFXP_XP_DIVISOR_FAMILIAR = 0.2; Changed 5/23/2015
