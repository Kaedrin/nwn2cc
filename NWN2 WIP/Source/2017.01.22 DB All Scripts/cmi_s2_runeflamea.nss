...
int GetFieryBurstReserveDamageDice(object oCaster)
{

	if (GetHasSpell(116,oCaster) || GetHasSpell(158,oCaster) || GetHasSpell(48,oCaster) )
		return 9;
								
	if (GetHasSpell(89,oCaster) || GetHasSpell(2025,oCaster))
		return 8;
		
	if ( GetHasSpell(39,oCaster) || GetHasSpell(57,oCaster) )
		return 7;	
												
	if ( GetHasSpell(61,oCaster) || GetHasSpell(440,oCaster) || GetHasSpell(446,oCaster) || GetHasSpell(869,oCaster) || GetHasSpell(871,oCaster) )
		return 5;						
		
	if ( GetHasSpell(47,oCaster) || GetHasSpell(191,oCaster) || GetHasSpell(1826,oCaster) || GetHasSpell(1208,oCaster))
		return 4;
			
	if ( GetHasSpell(58,oCaster) || GetHasSpell(59,oCaster) || GetHasSpell(1753,oCaster) || GetHasSpell(1759,oCaster) || GetHasSpell(1814,oCaster) )
		return 3;	
...
void main()
{
	...
	int nDamageDice = GetFieryBurstReserveDamageDice(oCaster);
