...
// RPGplayer1 05/08/08 - Second casting won't remove BAB increase
...
// End of Spell Cast Hook
    ...
    //RemoveEffectsFromSpell(oTarget, GetSpellId()); //removed to prevent some problems with BAB increase
    RemoveTempHitPoints();
