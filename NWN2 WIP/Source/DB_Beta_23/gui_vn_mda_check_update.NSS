...
//------------------------------------------------------------------------------
//  Script Name: gui_vn_mda_check_update(string sUIName, string sUIVersion)
...
const string VN_CHARLIE_MDA_SCENE = "vn_item_appearance_changer";
const string VN_CHARLIE_MDA_NAME = "Charlie's Appearance Changer";
const int VN_CHARLIE_MDA_VERSION = 105;
...
void main(string sUIName = "", string sUIVersion="")
{
	...
	if (sUIName == "" || sUIVersion == "") 
	{
		...
		SendMessageToPC(oPC, "Bad UI callback to [gui_vn_mda_check_update]");
		return; 
	}
	...
	// Charlie's Item Modifier
	if (sUIName == VN_CHARLIE_MDA_SCENE)
		CheckVersion(oPC, VN_CHARLIE_MDA_NAME, nUIVersion, VN_CHARLIE_MDA_VERSION);
