...
void main()
{
	...
	if (nSpellId == SPELL_Orb_Electricity)
	{
	...
	if (GetIsObjectValid(oTarget))
	{
		...
		{		
			...
			if (nRangedTouch != TOUCH_ATTACK_RESULT_MISS)
			{
				...
				if (nSpellId == SPELL_Orb_Sound && GetHasSpellEffect(FEAT_LYRIC_THAUM_SONIC_MIGHT,OBJECT_SELF))					
					nDamage += d6(4);
