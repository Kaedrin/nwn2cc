...
void main()
{
    ...
    */
    ...
    if (GetCreatureFlag(OBJECT_SELF, CREATURE_VAR_IS_INCORPOREAL) == TRUE)
    {
    	...
    	//set's a listening pattern
	SetListening(OBJECT_SELF, TRUE);	
	SetListenPattern(OBJECT_SELF, "**(Slave|slave)**(come|get)**over**here**", 2001);
    SetListenPattern(OBJECT_SELF, "(Slave|slave|Slave!|slave!|Ella!)", 2002);
	...
	ExecuteScript("vn_tre_OC_override",OBJECT_SELF);
