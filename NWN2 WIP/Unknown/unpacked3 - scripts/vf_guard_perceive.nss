...
string WARNING1c = "Verdantfalls does not allow people walking about armed.";


//The second warning - edit as above
string WARNING2 = "By Mededogem! I said put away your weapon!";
...
//The Battlecry
string ATTACK_MSG = "Pay for your folly!";//Attack here
string ATTACK_MSG2 = "You insolant fool!";
string ATTACK_MSG3 = "Then choose death!";
string ATTACK_MSG4 = "So be it, I'll do the world a favor!";
...
void main()
{
    object oPC;
        ...
        oPC = GetNearestCreature(CREATURE_TYPE_PLAYER_CHAR, PLAYER_CHAR_IS_PC, OBJECT_SELF);
            ...
            if (GetItemPossessedBy(oPC, "vf_guardbadge")!= OBJECT_INVALID)
             ...
             else if(((item = GetItemInSlot(INVENTORY_SLOT_RIGHTHAND,oPC))!=OBJECT_INVALID) && (GetBaseItemType(oWeapon)!=BASE_ITEM_MAGICSTAFF))
             {
