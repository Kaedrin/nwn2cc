...
void main()
{
	...
	int nCasterLvl = GetLevelByClass(CLASS_WARRIOR_DARKNESS);
	...
	if (nSpellId == WOD_DARKLING_WEAPON || nSpellId == WOD_DARKLING_WEAPON_FLAMING)
	{
	...
	else if (nSpellId == WOD_DARKLING_WEAPON_FROST)
	{
	...
	else if (nSpellId == WOD_DARKLING_WEAPON_SHOCK)
	{
