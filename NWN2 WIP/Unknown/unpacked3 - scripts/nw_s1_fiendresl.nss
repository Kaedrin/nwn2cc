...
// End of Spell Cast Hook
    ...
    int nHealAmt = 0;
     ...
     if ( GetHasFeat(FEAT_EPIC_FIENDISH_RESILIENCE_IV, oTarget, TRUE) )
    {
        nHealAmt = 40;
    }		
    else if ( GetHasFeat(FEAT_EPIC_FIENDISH_RESILIENCE_III, oTarget, TRUE) )
    {
        nHealAmt = 35;
    }	
    else if ( GetHasFeat(FEAT_EPIC_FIENDISH_RESILIENCE_II, oTarget, TRUE) )
    {
        nHealAmt = 30;
    }	
    else if ( GetHasFeat(FEAT_EPIC_FIENDISH_RESILIENCE_25, oTarget, TRUE) )
    {
        nHealAmt = 25;
    }
