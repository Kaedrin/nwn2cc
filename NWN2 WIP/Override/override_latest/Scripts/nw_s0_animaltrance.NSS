...
// RPGplayer1 04/24/2009: 
//  Will use caster levels, if not racial ability
//  fSize properly conveted to meters
...
void main()
{
	...
	fSize = fSize * (RADIUS_SIZE_GARGANTUAN/25.0);	//convert to meters, otherwise radius is waaay to large
