...
void main()
{
	...
	int nStormlord24HrBuffDuration = GetLocalInt(GetModule(), "Stormlord24HrBuffDuration");	
	if (nStormlord24HrBuffDuration)
		fDuration = HoursToSeconds(24); //24 hour option.	
	else
		fDuration = RoundsToSeconds(20);	// Always lasts 20 rounds.
