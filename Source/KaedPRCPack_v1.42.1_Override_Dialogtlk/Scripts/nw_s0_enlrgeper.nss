...
// RPGplayer1 03/28/08 - Removed Duergar Enlarge check (now part of HasSizeIncreasingSpellEffect) 
...
// End of Spell Cast Hook
	...
	RemoveEffectsFromSpell(oTarget, SPELL_REDUCE_PERSON);
	RemoveEffectsFromSpell(oTarget, SPELL_REDUCE_PERSON_GREATER);	
	RemoveEffectsFromSpell(oTarget, SPELL_REDUCE_PERSON_MASS);		
