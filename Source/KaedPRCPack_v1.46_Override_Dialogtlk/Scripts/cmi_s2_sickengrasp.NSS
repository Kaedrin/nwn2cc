...
void main()
{
	...
	if (GetIsObjectValid(oTarget))
	{
		...
		{		
			...
			effect eDamageDecrease = EffectDamageDecrease(nPenalty);
			effect eAB = EffectAttackDecrease(nPenalty);
			effect eSave = EffectSavingThrowDecrease(SAVING_THROW_ALL,nPenalty,SAVING_THROW_TYPE_ALL);
