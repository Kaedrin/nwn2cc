...
void main()
{
   	...
   	if(GetIsObjectValid(oMyWeapon) )
	{
		...
		IPSafeAddItemProperty(oMyWeapon, ItemPropertyDamageBonus(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEBONUS_1d6), RoundsToSeconds(nDur),X2_IP_ADDPROP_POLICY_KEEP_EXISTING);
